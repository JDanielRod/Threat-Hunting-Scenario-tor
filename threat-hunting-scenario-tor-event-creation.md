...
6. Create a folder on your desktop called ```tor-shopping.txt``` and put a few fake (illicit) items in there
7. Delete the file.
...
- **Author Contact**: https://www.linkedin.com/in/jdanielrod/
- **Date**: March 22, 2026  
